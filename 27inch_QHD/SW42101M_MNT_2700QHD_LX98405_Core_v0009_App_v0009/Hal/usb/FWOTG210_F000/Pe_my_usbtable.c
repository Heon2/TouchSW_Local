...
uint8_t u8_HID_MultiTouch_Descriptor_Main[HID_MULTITOUCH_DESC_MAIN_LENGTH] =
{
	...
	0x26, LSB(X_Y_LOGICAL_MAX), MSB(X_Y_LOGICAL_MAX), // LOGICAL_MAXIMUM (32767)
	0x75, 0x10,                         //       REPORT_SIZE (16)
	0x55, 0x0D,                         //       UNIT_EXPONENT (-3)
	0x65, 0x11,                         //       UNIT(SI Lin, Distance) ¡§u¡§uA¡Ë¢ç¨ÏoIAI ¡Ë¡ÍUA¢®¡¿
	0x09, 0x30,                         //       USAGE (X)
...
uint8_t u8_HID_MultiTouch_Descriptor_Tail[HID_MULTITOUCH_DESC_TAIL_LENGTH] =
{
	...
	0x75, 0x20,
	0x95, 0x01,
	0x09, HID_TOUCH__DEBUG1,	// 4Bytes
	0x81, 0x02,
	0x09, HID_TOUCH__DEBUG2, 	// 4Bytes
	0x81, 0x02,
    0x09, HID_TOUCH__DEBUG3, 	// 4Bytes
	0x81, 0x02,
    0x09, HID_TOUCH__DEBUG4, 	// 4Bytes
	0x81, 0x02,
    0x09, HID_TOUCH__DEBUG5, 	// 4Bytes
	0x81, 0x02,
    0x09, HID_TOUCH__DEBUG6, 	// 4Bytes
	0x81, 0x02,
    0x09, HID_TOUCH__DEBUG7, 	// 4Bytes
	0x81, 0x02,
	0x75, 0x10,
	0x95, 0x01,
	0x09, HID_TOUCH__DEBUG8, 	// 2Bytes
	0x81, 0x02,
	...
	0xA1, 0x01,						// Collection (Application),
	0x85, HID_REPORT_ID__MOUSE,		// REPORT_ID (Mouse)
	...
	0x81, 0x02,						// Input (Data, Variable, Absolute), (2 position bytes - X & Y)
	0xC0,							// End Collection
	0xC0,
#endif
};
...
uint8_t u8_HID_Pen_Descriptor[HID_PEN_DESC_LENGTH] =
{
	...
	// Serial Number
	0x05, 0x0D,
	0x09, HID_PEN__TRANSDUCER_SERIAL_NUM,
	0x17, 0x00, 0x00, 0x00, 0x80,
	0x27, 0xFF, 0xFF, 0xFF, 0x7F,
	0x37, 0x00, 0x00, 0x00, 0x80,
	0x47, 0xFF, 0xFF, 0xFF, 0x7F,
	0x75, 0x20,
	0x81, 0x02,

	// Reserved (VID)
	0x06, 0x00, 0xFF,
	0x09, HID_PEN__RESERVED,
	0x75, 0x08,
	0x15, 0x00,
	0x26, 0xFF, 0x00,
	0x35, 0x00,
	...
	0x09, 0x02,                         // USAGE (Pen)        
	0xa1, 0x01,                         // COLLECTION (Application)         
	0x85, HID_REPORT_ID__PEN_SECOND,           //   REPORT_ID (Pen)                
	0x09, 0x20,                         //   USAGE (Stylus)    
