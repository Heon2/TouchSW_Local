...
#include "env_def.h"
#include "systick.h"
#include "SIW42101_Version.h"


	//#define IRQ_FOTG200 					40	//27
	#define FOTG200_BASE_ADDRESS			BASE_USB
//========== 1.Define Data Type  =========================================================================================
...
//	typedef signed int int32_t;			/* 4 bytes */
	...
	// Remote Wakeup
	#define REMOTE_WAKEUP_ADDR				0x4000006CUL
	...
	#define mUsbRemoteWakeUpSet_SEL_WAKEUP()			(REMOTE_WAKEUP_Port(0x00) &= ~BIT4)
	#define mUsbRemoteWakeUpST_BIT4()			(REMOTE_WAKEUP_Port(0x00) & BIT4)
...
// GPIO Interrupt
#define I2C_GPB10__LOW					0x00
#define I2C_GPB10__HIGH					0x01

// Command �����͸� ó���ϴ� ���߿��� Touch, Custom, Pen �� ó������ �ʵ���
...
// Connect Status
#define I2C_CONNECT_PC					0
#define I2C_CONNECT_TOOL				1 // Default
#define I2C_CONNECT_TOOL_0x150			2
...
{
	//uint16_t	DescLength; // I2C_IRQHandler ���� 2����Ʈ�� ���� ó�� �ϱ� ������ �� �κ� �ʿ� ����
	uint16_t	BCDVersion;
...
// HID Report ID
#define HID_REPORT_ID__MOUSE 			0x02
#define HID_REPORT_ID__LATENCY_MODE		0x05
...
#define USE_USB_HID_TOUCH_DEBUG			(NO)
...
#define TOUCH_DEBUG_LENGTH 				49
#else
#define TOUCH_DEBUG_LENGTH 				0
#endif



#define HID_MULTITOUCH_DESC_HEAD_LENGTH	(0x08)	
#define HID_MULTITOUCH_DESC_MAIN_LENGTH	0x40 //0x3C
#define HID_MULTITOUCH_DESC_TAIL_LENGTH	(CONTACT_COUNT_LENGTH + SCAN_TIME_LENGTH + MAX_COUNT_LENGTH + BLOB_CODE_LENGTH + LATENCY_LENGTH + DEVICE_MODE_LENGTH + MOUSE_LENGTH + TOUCH_DEBUG_LENGTH + 1)
#if USE_USB_HID_TOUCH_DEBUG
#define HID_MULTITOUCH_DESC_TOTAL_LENGTH (HID_MULTITOUCH_DESC_HEAD_LENGTH + (HID_MULTITOUCH_DESC_MAIN_LENGTH * HID_MAX_TOUCH_HYBRID) + HID_MULTITOUCH_DESC_TAIL_LENGTH)
#else
...
// 27" LGD_MNT
#define X_PHYSICAL_MAX					52704	// ��ġ���� ���� (30.931 cm)
#define Y_PHYSICAL_MAX					29646	// ��ġ���� ���� (17.399 cm)

// 14 "
//#define X_PHYSICAL_MAX					30931	// ��ġ���� ���� (30.931 cm)
//#define Y_PHYSICAL_MAX					17399	// ��ġ���� ���� (17.399 cm)
// 13.3"
// X, Y Physical Maximum
//#define X_PHYSICAL_MAX					29376	// ��ġ���� ���� (29.376 cm)
//#define Y_PHYSICAL_MAX					16524	// ��ġ���� ���� (16.524 cm)

// X, Y Logical Maximum
#define X_Y_LOGICAL_MAX					32767

#define SCAN_TIME_MAX					65535

#if USE_USB_HID_TOUCH_DEBUG
#define HID_TOUCH__DEBUG1				0x04
#define HID_TOUCH__DEBUG2				0x05
#define HID_TOUCH__DEBUG3				0x06
#define HID_TOUCH__DEBUG4			    0x07
#define HID_TOUCH__DEBUG5				0x08
#define HID_TOUCH__DEBUG6				0x09
#define HID_TOUCH__DEBUG7				0x0A
#define HID_TOUCH__DEBUG8				0x0B
#endif
...
typedef struct _HID_MULTITOUCH_HYBRID
{
    ...
    #if USE_USB_HID_TOUCH_DEBUG
    // Debug
	uint32_t 	Debug32bit[7];
	uint16_t 	Debug16bit[1];
    #endif
...
#define HID_CUSTOM_DESC_LENGTH			0x26
...
typedef struct
{
	...
	uint16_t Length;
	uint8_t Data[58];
} MNT_HID_TEST_STRUCT, *PMNT_HID_TEST_STRUCT;
...
#ifdef ADD_DUAL_PEN
	#define HID_PEN_COUNT 				2
#else
	#define HID_PEN_COUNT 				1
#endif


#define HID_PEN_DESC_LENGTH				(((0x94 + PEN_AZIMUTH_LENGTH + HID_PEN_SCAN_TIME_LENGTH)*HID_PEN_COUNT) + (PEN_EXTRA_LENGTH*HID_PEN_COUNT))
...
// Pen Extra
#define HID_PEN__TRANSDUCER_TYPE		0x5B
#define HID_PEN__TRANSDUCER_SERIAL_NUM	0x5C
#define HID_PEN__BATTERY_LEVEL			0x3B
#define HID_PEN__RESERVED				0x00
...
#ifdef ADD_PEN_EXTRA
	uint32_t	TransducerIndex_PenID : 13;
	uint32_t	TransducerIndex_WacomID_LSB : 19;
#ifdef ADD_WACOM_51BIT
	uint32_t	TransducerIndex_WacomID_MSB;
#endif
	
	uint32_t	SerialNumber;
	uint8_t		VendorID;
	uint8_t		BatteryStlength;
#endif
...
// I2C
void SendTouchData_I2C(PHID_MULTITOUCH_I2C pTouchData);
...
//uint8_t MNT_HID_Mapping_handler(uint8_t InData);
