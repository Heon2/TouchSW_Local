...
// Command 데이터를 처리하는 도중에는 Touch, Custom, Pen 을 처리하지 않도록
...
{
	//uint16_t	DescLength; // I2C_IRQHandler 에서 2바이트를 먼저 처리 하기 때문에 이 부분 필요 없음
	uint16_t	BCDVersion;
...
// Windows 10 버전 1511 까지는 이 기능을 지원하고 있지 않음
//define LATENCY_MODE
...
#define HID_MULTITOUCH_DESC_MAIN_LENGTH	0x40
...
// //14 "
//#define X_PHYSICAL_MAX					30931	// 센치미터 단위 (30.931 cm)
//#define Y_PHYSICAL_MAX					17399	// 센치미터 단위 (17.399 cm)
//#elif (USED_MODULE_DEF == MODULE_DEF_S_1 || USED_MODULE_DEF == MODULE_DEF_L_1)
//// 13.3"
//// X, Y Physical Maximum
//#define X_PHYSICAL_MAX					29376	// 센치미터 단위 (29.376 cm)
//#define Y_PHYSICAL_MAX					16524	// 센치미터 단위 (16.524 cm)
//#endif
