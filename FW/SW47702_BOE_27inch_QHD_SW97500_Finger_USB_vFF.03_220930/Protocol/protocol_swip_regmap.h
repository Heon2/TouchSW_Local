...
#define SWIP_REG_ADDR_PTINSPECTION               0x0B00
#define SWIP_REG_ADDR_PTINSPECTION_GET_INFO      0x0B00
#define SWIP_REG_ADDR_PTINSPECTION_SET_INFO      0x0B20
...
#define SWIP_REG_ADDR_GENERAL_BUFFER             0x2010 // Resolved to Conflict HID Address (if HID Address is 0x0020, little-Endian Sending is 0x2000)
