...
typedef struct
{
	uint8_t  ucExpectClipping_Finger_On;
...
typedef struct
{
	...
	uint8_t TouchDownFrameMax;
	uint8_t PalmTouchDownFrameMax;
	uint8_t TouchDownConnectDist;
	uint8_t PalmTouchDownConnectDist;
