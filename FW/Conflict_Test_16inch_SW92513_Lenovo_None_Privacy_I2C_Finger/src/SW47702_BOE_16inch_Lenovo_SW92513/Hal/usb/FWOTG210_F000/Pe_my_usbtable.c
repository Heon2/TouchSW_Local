...
{
	0x06, 0x01, 0xFF,						// USAGE_PAGE (Custom)
...
#if USED_WACOM_HIDI2C_DRIVER
uint8_t u8_HID_WacomPen_Descriptor[HID_WACOM_PEN_DESC_LENGTH] =
{
	0x06, 0x00, 0xFF,                   // USAGE_PAGE (Digitizers)    
	0x09, 0x02,                         // USAGE (Pen)      
	0xa1, 0x01,                         // COLLECTION (Application)         
	0x85, HID_REPORT_ID__WACOM_PEN,     //   REPORT_ID (Pen)                
	0x09, 0x20,                         //   USAGE (Stylus)    
