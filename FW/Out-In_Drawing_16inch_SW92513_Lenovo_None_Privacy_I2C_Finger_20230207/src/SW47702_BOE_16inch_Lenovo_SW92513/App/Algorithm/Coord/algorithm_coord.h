...
//Heon
	tPos_t		   tOutInPos;
	tPos_t		   tFirstOutInPos;
	
	bool_t		   bOutInFlag[POSBUF_];
	bool_t		   bOutInFlag2[POSBUF_];
	bool_t		   bFirstOutInFlag[POSBUF_];
//Heon
...
extern void algorithm_coord_UpdatePosHistoryInfo_OutInDrawing(void);
