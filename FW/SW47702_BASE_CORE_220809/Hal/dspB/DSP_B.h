...
//void algorithm_local_tmp_sw(int Ret);
...
extern void algorithm_baseline_calculate_local_mux_range(int r, int c, bool_t mode);
extern void algorithm_coord_init_local(void);
extern void algorithm_RangeExtend(int mode);
extern void algorithm_Tilt_PreFilter(void);
extern void algorithm_Tilt_PostFilter(void);
extern void algorithm_Tilt_RangeTestCheck(void);
extern void algorithm_PenNoiseReduction(int mode);
extern void algorithm_local_WGP_Ring_delta_coordi(int mode);
extern void algorithm_Tilt_Calculaion(uint8_t OpType, uint8_t mode);
#if USED_TOUCH_TUNING_PROCESS
extern void alogorithm_local_linefilter_1(int mode);
#endif
extern void algorithm_coord_PostProcess_Local(void);
extern void algorithm_param_change_check(void);
extern void algorithm_init_param_dsp(void);
#if IS_WGPUHDPEN_PROTOCOL_OPERATION
extern void algorithm_local_Ring_direc_delta_base_pos(void);
#endif
extern void algorithm_local_baseline_calculate_delta_Tilt(int mode);
...
//extern void algorithm_local_RingMS_delta_coordi(int mode);
//#endif
typedef struct
{
//    int16_t     cId;             						
//    tRect_t     tValidRect;       						
    int16_t     s3x3Val;   						
//    int16_t     sValidMaxVal;     						
//    tCell_t     tValidMaxPos;     						
    tXY_t       tCoord;           						
//    uint32_t    ulStrength;       						
//    uint32_t    ulExtStrength;  
	uint8_t		MaxDirecNum;	
#if (UseLastContact3x3 == YES)
	int16_t sLastContact3x3Val;
#endif
} __PACKED tRingMSInfo_t;    
