...
..\tool\bin_tool.exe -fullsbtotal "bin\Binary\APP_FULLMEM.img" "bin\Binary\TOTAL_FULLMEM.img" "..\ref\BOOT_NoTrim_702_vFF.01.img" "bin\Binary\APP.bin" "..\ref\APP_SIMPLE_BOOT.bin"
